...
from webapp.models import Delivery, PaymentType, PickupTask, User, Product, ProductColor, ProductSize, Region, Address, Role
...
def create_module(app, **kwargs):
    ...
    models1 = [Region, Address, PaymentType, Role]
