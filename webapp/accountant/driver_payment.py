...
def accountant_driver_payments():
    ...
    if form1.validate_on_submit():
        ...
        if len(line_order_id_values) > 0:
            if int(form1.card_amount.data) + int(form1.cash_amount.data) + int(form1.remaining_amount.data) == int(selected_order_total):
                driver_name = ""
                driver_id = 0
                ...
                accountant_order_history.delivery_ids = str(line_order_id_values)
