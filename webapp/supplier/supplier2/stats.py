...
from webapp.supplier.supplier2.forms import DateSelect
import calendar
import pytz
...
def supplier2_stats():
    ...
    return render_template('/shared/stats.html', title='Хүргэлт стастистик', data1=completed, data2=cancelled, data_total=total_monthly_orders)



@supplier2_stats_blueprint.route('/supplier2/balance', methods=['GET','POST'])
@login_required
@has_role('supplier2')
def supplier2_balance():
    ...
    if form.select_date.data is not None and form.validate_on_submit():
        ...
        return render_template('/supplier/supplier2/supplier_calculations.html', supplier_datas=supplier_datas, current_date=current_date, day_list=days_data, form=form)
